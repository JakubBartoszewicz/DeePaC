...
sed -i 's/RunName.*/RunName = '$model_name'/g' eval_config_paired.ini
sed -i 's/DataSet.*/DataSet = '$test_set_1'/g' eval_config_paired.ini
sed -i 's/PairedSet.*/PairedSet = '$test_set_2'/g' eval_config_paired.ini
