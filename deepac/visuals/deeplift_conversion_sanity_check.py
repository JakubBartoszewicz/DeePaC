...
#Install deeplift from https://github.com/kundajelab/deeplift/
import deeplift
...
# Creates deeplift model from keras model and checks whether the conversion was successful
# by comparing the predictions of the original model and the deeplift model
...
deeplift_model = \
    conversion.convert_model_from_saved_files(model_file,
...
y_pred_deeplift = np.ndarray.flatten(np.array(deeplift.util.run_function_in_batches(input_data_list=[x_test],
