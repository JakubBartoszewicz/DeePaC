...
class BuiltinLoader:
    ...
    def load_sensitive_model(self, n_cpus=None, n_gpus=None, log_path="logs", training_mode=True, use_tpu=False):
        return self.__load_builtin_model("sensitive", n_cpus, n_gpus, log_path, training_mode)

    def load_rapid_model(self, n_cpus=None, n_gpus=None, log_path="logs", training_mode=True, use_tpu=False):
